...
//        String password = request.getParameter("password");
//        Customer newCustomer = new Customer(customerName,customerAge,customerAddress,customerPhone,customerEmail,account,password);
//        customerDAO.insertCustomer(newCustomer);
//        RequestDispatcher dispatcher = request.getRequestDispatcher("customer/create.jsp");
//        dispatcher.forward(request, response);
//    }
...
//        RequestDispatcher dispatcher = request.getRequestDispatcher("customer/searchbyname.jsp");
//        dispatcher.forward(request, response);
//    }
//
//    private void sortCustomer(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
...
//    }
//}
//>>>>>>> 78c2c93aca0d5d5d872a9c574b1784ef6c0e6fc1
